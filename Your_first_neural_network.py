...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            hidden_error_term = np.dot(self.weights_hidden_to_output, output_error_term.T)*(hidden_outputs*(1-hidden_outputs)).T
...
#  
# 
# 1.预测效果较好吧，因为数据不是很大，epochs够大，lr够小，理论上应该能让val_loss趋于0.
# 2.最后的输出没有进行激励函数变换，可能也是影响效果的原因之一。
# 3.神经网络隐藏层的数量增加，也应该可以进一步提升效果。
# 4.可能数据本身也有缺陷。
